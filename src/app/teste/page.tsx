  ...
  return (
    <div className='container bg-swirl'>
      <Header/>
        ...
        <div className="relative group duration-500 ml-40 mt-20 cursor-pointer group overflow-hidden relative text-gray-50 h-[600px] w-[400px]  rounded-2xl hover:duration-700 duration-700">
